...
", CClientScript::POS_READY);
    ...
    <div id='buttondel' style='margin: 0 40%;display: none;' class="row buttons">
        ...
        echo CHtml::ajaxSubmitButton(
                'Удалить рассылку', CController::createUrl('process/view'), array('type' => 'POST',
    ...
    ?>
        ...
        <div class="row">
            ...
            <div class='file_input_div'>
                <?php
                echo $form->fileField($model, 'attach', array(
    ...
    <?php echo $form->checkBox($model, 'attached'); ?>
            ...
            <div class="row">
                ...
                <div>
                    ...
                    <?php
                    $this->widget('CCaptcha', array('clickableImage' => true, 'showRefreshButton' => true, 'buttonLabel' => CHtml::image(Yii::app()->baseUrl
            ...
            <div class="row">
        <?php
        echo $form->labelEx($model, '', array('class' => 'leftlabel'));
